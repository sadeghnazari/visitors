...
return [
	...
	/**
	 * The Do Not Track Ips is used to disable Visitors for some IP addresses:
	 *
	...
	/**
	 * If you prefer to store Visitors data on a different database or connection,
	 * you can set it here.
	 *
	 * To avoid SQL queries log recursion, create a different connection for Visitors,
	 ...
	 *
	 * To avoid recursion, you better ignore Visitors connection here.
	 *
	 * Please create a separate database connection for Visitors. It can hit
	 ...
	 */
	'store_cookie_visitors' => true,

	/**
	 * If you are storing cookies, you better change it to a name you of your own.
	 */
	'visitors_cookie_name' => 'please_change_this_cookie_name',

	/**
	 * Internal visitors session name.
	 */
    'visitors_session_name' => 'visitors_session',

	/**
	 * ** IMPORTANT **
	 *   Change the user model to your own.
	 */
	'user_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\User',

	/**
	 * You can use your own model for every single table Visitors has.
	 */

    'session_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Session',

    'log_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Log',

    'path_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Path',

    'query_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Query',

    'query_argument_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\QueryArgument',

    'agent_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Agent',

    'device_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Device',

    'cookie_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Cookie',

    'domain_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Domain',

    'referer_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Referer',

    'referer_search_term_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\RefererSearchTerm',

    'route_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Route',

    'route_path_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\RoutePath',

    'route_path_parameter_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\RoutePathParameter',

    'error_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Error',

    'geoip_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\GeoIp',

    'sql_query_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\SqlQuery',

    'sql_query_binding_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\SqlQueryBinding',

    'sql_query_binding_parameter_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\SqlQueryBindingParameter',

    'sql_query_log_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\SqlQueryLog',

    'connection_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Connection',

    'event_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\Event',

    'event_log_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\EventLog',

    'system_class_model' => 'Blanfordia\Visitors\Vendor\Laravel\Models\SystemClass',
     ...
     */
    'stats_layout' => 'blanfordia/visitors::layout',

    /**
     * Stats Panel controllers namespace
     */
    'stats_controllers_namespace' => 'Blanfordia\Visitors\Vendor\Laravel\Controllers',
];
