...
namespace Blanfordia\Visitors\Vendor\Laravel\Artisan;
...
class Tables extends Base {
	 ...
	 * @var string
	 */
	protected $name = 'visitors:tables';
	 ...
	 * @var string
	 */
	protected $description = 'Create the migrations for Visitors database tables and columns';
